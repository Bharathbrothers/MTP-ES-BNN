...
random failures (RNF): each process has a chance of 0,1 % to fail regardless of its process parameters. This is the case for only 5 datapoints, less than could be expected for 10,000 datapoints in our dataset.     '''
    ...
    <h2 style="color:white;text-align:center;"> Hello User! your Machine is Safe!!</h2>
    </div>
"""
    warn_html ="""  
...
"""
    fail_r1 = """
    <div style="background:#050256 ;padding:10px">
    <h4 style="color:white;text-align:left;">Heat dissipation failure: Solution </h2>
    </div>
    """
    fail_r2 = """
    <div style="background:#050256 ;padding:10px">
    <h4 style="color:white;text-align:left;">Tool wear failure: Solution</h2>
    </div>
    """
    fail_r3 = """
    <div style="background:#050256 ;padding:10px">
    <h4 style="color:white;text-align:left;">Power failure: Solution</h2>
    </div>
    """
    fail_r4 = """
    <div style="background:#050256 ;padding:10px">
    <h4 style="color:white;text-align:left;">Overstrain failure: Solution</h2>
    </div>
    """
